import { DesrializedStore, HydrationStore, IHydrationStore } from '@next-mobx-store/type';
import { ExcludeType } from '@next-mobx-store/type/Utils';
import { ObservableMap, ObservableSet, action, makeAutoObservable, observable } from 'mobx';
...
export default class AllObservableTypeStore implements IHydrationStore {
	...
	private _observableMapState: ObservableMap<string, any> = observable.map<string, any>();
	...
	allSetter(obj: Partial<ExcludeType<AllObservableTypeStore, CallableFunction>>) {
	...
	setObservableMapOptionalState(observableMapOptionalState: ObservableMap<string, any>) {
	...
	setObservableSetOptionalState(observableSetOptionalState: ObservableSet<string>) {
